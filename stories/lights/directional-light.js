...
export default function DirectionalLightStory(): React.ReactNode {
  ...
  const helperColorInput = text(
    "helperColor (input)",
    "white",
    KNOB_GROUP.ENVIRONMENT
  );
  const helperColor = colorPicker(
    "helperColor",
    helperColorInput !== "" ? helperColorInput : undefined,
    KNOB_GROUP.ENVIRONMENT
  );
